...
echo '#define VERSION_MACRO' >"config_adv360/version.dtsi"
echo 'macro_ver: macro_ver {' >>"config_adv360/version.dtsi"
echo 'compatible = "zmk,behavior-macro";' >>"config_adv360/version.dtsi"
echo 'label = "macro_ver";' >>"config_adv360/version.dtsi"
echo '#binding-cells = <0>;' >>"config_adv360/version.dtsi"
echo "bindings = $formatted_result;" >>"config_adv360/version.dtsi"
echo '};' >>"config_adv360/version.dtsi"
